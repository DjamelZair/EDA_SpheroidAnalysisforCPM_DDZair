...
(function () {
  ...
  var HELP = {
    ...
    qualcoverage: "Each dot is one real control well (n=48), placed by an image-quality metric against how far the well sits from its nearest synthetic spheroid in morphology space. Switch the metric to see which quality predicts distance: focus/blur does (r=+0.43), contrast does not (r=+0.03), and more-fragmented wells sit slightly closer (r=-0.30). Clay dots are beyond the p95 distance (out of library); the gold line is the linear trend.",
